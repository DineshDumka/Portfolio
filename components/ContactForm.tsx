...
// Public Formspree form ID — safe to commit (it's client-side by design)
const FORM_ID = 'xaqkrpjq';
                ...
                <div className="contact-container">
                    ...
                    {state.succeeded ? (
                        <div className="contact-success-card card">
                            ...
                            <h3 className="contact-success-heading">Message delivered!</h3>
                        ...
                        <form onSubmit={handleSubmit} className="contact-form card" noValidate>
                            ...
                            <div className="form-group">
                                <label htmlFor="cf-email" className="form-label">
                                    Email{' '}
                                    <span className="form-label-hint">(so I can reply)</span>
                                </label>
                                <input
                                    type="email"
                                    id="cf-email"
                            ...
                            {/* Global form-level errors (spam, network, etc.) */}
                            <ValidationError
                                errors={state.errors}
                    ...
                    <div className="contact-social">
                        ...
                        <div className="social-links-grid">
                            ...
                            <a
                                href="https://www.linkedin.com/in/dinesh-dumka/"
                                target="_blank"
                                rel="noopener noreferrer"
                                className="social-link social-link-3d"
                            ...
                            <a
                                href="https://www.instagram.com/dinesh_dumka/"
                                target="_blank"
                                rel="noopener noreferrer"
                                className="social-link social-link-3d"
                            ...
                            <a
                                href="mailto:dineshdumka27@gmail.com"
                                className="social-link social-link-3d"
                                aria-label="Email Dinesh"
                            >
                                <svg className="social-icon" viewBox="0 0 24 24">
